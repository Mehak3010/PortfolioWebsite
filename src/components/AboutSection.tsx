        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                Currently exploring AI/ML, Python development, and UI/UX design while building projects 
              ...
              <div className="grid grid-cols-2 gap-4 mt-8">
                ...
                <Card className="p-4 text-center shadow-neon hover:shadow-glow transition-smooth border-accent/20">
                  <h3 className="text-2xl font-bold bg-gradient-neon bg-clip-text text-transparent">2+</h3>
